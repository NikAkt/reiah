  ...
  return (
    <div>
      <div class="w-full aspect-square border rounded-lg overflow-hidden mb-3 bg-transparent">
        <img
          src="https://images.pexels.com/photos/1389339/pexels-photo-1389339.jpeg?cs=srgb&dl=pexels-wildlittlethingsphoto-1389339.jpg&fm=jpg"
      ...
      <div>
        ...
        <div class="text-neutral-500 font-extralight text-sm">
...
export { MapAreaCard, MapAreaCardSkeletonLoader };
