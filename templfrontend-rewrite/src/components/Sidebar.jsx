...
const DarkLightModeToggle = () => {
  return (
    <>
      <div class="h-7 aspect-square hover:cursor-pointer" onClick={() => {
...
const SidebarLink = (props) => {
  return (
    ...
    <li class="mb-1 group">
      <a href={props.link.Href} class="flex items-center py-2 px-4 text-gray-900 dark:text-slate-200 hover:bg-gray-950 hover:text-gray-100 dark:hover:text-gray-950 dark:hover:bg-gray-100 rounded-md">
...
const Sidebar = (props) => {
  return (
    <>
      <div class="fixed top-0 w-5 min-h-screen left-0 bg-transparent z-40" onMouseEnter={() => setStore({ ...store, sidebarOpen: true })} ></div >
      <div
        ...
        <div class="flex items-center justify-between pb-4 border-b border-b-gray-800">
          <a href="/" class="flex items-center" hx-boost="true">
            <h2 class="font-bold text-2xl text-black dark:text-white">
              REIAH <span class="bg-teal-500 dark:bg-teal-300 text-white dark:text-black px-2 rounded-md">HUB</span>
            </h2>
          </a>
          <DarkLightModeToggle />
        </div>
