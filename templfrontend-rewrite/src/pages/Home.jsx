...
export const Home = () => {
  return (
    <BaseLayout>
      <header
        class="flex justify-between items-center py-4 px-8 text-white"
        style={{ backgroundColor: "#0FA6A2" }}
      >
      ...
      <div class="flex flex-col md:flex-row items-center justify-between mt-8 mx-4 md:mx-16">
        <div class="text-left max-w-md">
          <h1 class="text-4xl font-bold text-teal-500">
            Accelerate your real estate journey with Reiah
          </h1>
          <span class="text-sm text-teal-500 italic">Pronounced ray-ah</span>
          <p class="mt-4 text-gray-700">
            Jump in! Reiah helps you discover the perfect zip code to invest in,
